...
public interface WorkFlowConstants {
    ...
    String PROCESS_CACHE_KEY_PREFIX="flwProcessModel#";
    String PROCESS_TEMPLATE_INFO="processTemplateInfo";
    String PROCESS_PREFIX="Flowable";
    String START_EVENT_ID="startEventNode";
    String END_EVENT_ID="endEventNode";
    String EXPRESSION_CLASS="T(com.dingding.mid.utils.ExUtils).";
